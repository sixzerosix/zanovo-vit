...
gsap.registerPlugin(ScrollTrigger)
	...
	document.addEventListener("DOMContentLoaded", () => {
		...
		const scrollVideos = gsap.utils.toArray<HTMLVideoElement>('.video-card video');
		...
		scrollVideos.forEach((video) => {
			...
			const overlay = video.parentElement?.querySelector('.play-overlay') as HTMLElement | null;
